...
export function Hero({ onCreateCanvas, isCreating }: HeroProps) {
  ...
  return (
    <section className="relative isolate pt-7 pb-10 sm:pt-10 sm:pb-10 overflow-hidden">
      {/* Grid Pattern Background */}
      <div className="absolute bottom-0 left-0 right-0 top-0 pointer-events-none z-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]" />

      {/* Subtle radial ambient background glows */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[400px] bg-gradient-to-tr from-blue-400/10 via-indigo-400/10 to-purple-400/10 rounded-full blur-[140px] pointer-events-none z-0" />
